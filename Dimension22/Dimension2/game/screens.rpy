...
screen quick_menu():
    ...
    if quick_menu:
        add Color((41, 41, 41, 112)) xalign 0.5 yalign 1.0 size(710, 30) #add this and adjust the size and color as required s
        hbox:
            style_prefix "quick"
...
screen main_menu:
    ...
    #메인 메뉴에서 기본 배경
    add Movie(play="images/main_menu animate.mpg") xalign 0.5 yalign 1.1 # xalign ,yalign은 이미지의 위치를 조절합니다.
